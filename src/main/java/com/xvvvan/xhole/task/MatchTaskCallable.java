...
public class MatchTaskCallable implements Callable<WebIdentifyData> {
    ...
    public MatchTaskCallable(xHoleTemplate matcher, Map<String, Object>  requestMap, AtomicInteger id , ObservableList<WebIdentifyData> list){
